...
public class CRUDUtils {
    ...
    public static void addPlayer() {
        ...
        if (!searchPlayerId(playerId)) {
            ...
            Player player = new Player(playerId, name, ProgresToArray(prog), CurrToArray(curr), ItemToArray(item));
            savePlayer(player);
        } else {
    ...
    public static void deleteProgress() throws SQLException {
    ...
    public static void updateCurrencies() throws SQLException {
    ...
    public static void deleteCurrencies() throws SQLException {
        System.out.println("Введите id прогресса: ");
        String id = scanner.next();
